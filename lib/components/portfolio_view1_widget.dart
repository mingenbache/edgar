...
import 'portfolio_view1_model.dart';
export 'portfolio_view1_model.dart';

class PortfolioView1Widget extends StatefulWidget {
  const PortfolioView1Widget({Key? key}) : super(key: key);

  @override
  _PortfolioView1WidgetState createState() => _PortfolioView1WidgetState();
}

class _PortfolioView1WidgetState extends State<PortfolioView1Widget> {
  late PortfolioView1Model _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => PortfolioView1Model());
                            ...
                            children: [
                              Expanded(
                                child: Column(
                                  ...
                                  children: [
                                    Image.asset(
                                      'assets/images/Logo_gold_big.png',
                                      height: 70.0,
                                      fit: BoxFit.cover,
                                    ),
                                  ],
                                  ...
                                  child: Padding(
                                    ...
                                    child: smooth_page_indicator
                                      ...
                                      effect: smooth_page_indicator
                                        ...
                                        activeDotColor: Color(0xFFE6DA22),
